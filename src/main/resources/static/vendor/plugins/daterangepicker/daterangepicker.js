...
(function(root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['static/vendor/plugins/daterangepicker/moment', 'jquery', 'exports'], function(momentjs, $, exports) {
      root.daterangepicker = factory(root, exports, momentjs, $);
    });

  } else if (typeof exports !== 'undefined') {
    var momentjs = require('static/vendor/plugins/daterangepicker/moment');
    var jQuery;
    try {
