...
public class AppConfigTests {
	...
	public void init(){
		sb.append("insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 15.99, sysdate, '/dist/product/bolivia-SingleOrigins.png');\n" +
				...
				"We love this coffee for its nuanced notes of spiced pear, chocolate, and floral aroma.', 12.99, sysdate, '/dist/product/HONDURAS_KEDVIN_MORENO-SingleOrigins.jpg');\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 13.99, sysdate, '/dist/product/guatemala-SingleOrigins.png');\n" +
				"\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 14.99, sysdate, '/dist/product/NATURAL_HIGH-Blends.jpg');\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 15.99, sysdate, '/dist/product/bean_martin-Blends.png');\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 18.99, sysdate, '/dist/product/BLEU_ORGANIC-Blends.jpg');\n" +
				"\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 18.99, sysdate, '/dist/product/ORGANIC_DECAF_HONDURAS-Decafs.jpg');\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 14.99, sysdate, '/dist/product/decaf_mexico-Decafs.png');\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 15.49, sysdate, '/dist/product/half_caf_blend-Decafs.png');\n" +
				"\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 21.99, sysdate, '/dist/product/KENYA_KIBUGU-Light.jpg');\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 18.99, sysdate, '/dist/product/WEST_END_BLUES_BLEND-Light.jpg');\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 14.59, sysdate, '/dist/product/sumatra-Light.png');\n" +
				"\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 13.99, sysdate, '/dist/product/cowboy-Medium.png');\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 13.99, sysdate, '/dist/product/dr-mojo-Medium.png');\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 18.99, sysdate, '/dist/product/BON_VIVANT-Medium.jpg');\n" +
				"\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 19.49, sysdate, '/dist/product/NIZZA_ESPRESSO_BLEND-Dark.jpg');\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 14.99, sysdate, '/dist/product/fire_in_the_belly-Dark.png');\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 13.49, sysdate, '/dist/product/frenchy_french_roast-Dark.png');\n" +
				"\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 130.00, sysdate, '/dist/product/BARATZA_ENCORE_BURR_GRINDER-grinder.jpg');\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"Gritty Details: </br>Swiss made steel conical grinding burr set, it comes with an anti-static brush, a ball driver tool, and a neoprene travel case!', 35.99, sysdate, '/dist/product/lido3_hand_grinder-grinder.png');\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"</br>Gritty Details</br>Features conical ceramic burrs, an anti-slip rubber base for easier grinding, the grind setting is easily adjustable, and it''s even dishwasher safe. ', 49.99, sysdate, '/dist/product/hario_skerton_hand_grinder-grinder.png');\n" +
				"\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 13.49, sysdate, '/dist/product/bonmac_ceramic_dripper-HomeBrewing.png');\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"features a removable silicone band, a removable plastic drip brewer and has a capacity of 25-5/8oz.', 36.49, sysdate, '/dist/product/hario-drip-brewer-and-decanter-HomeBrewing.png');\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"Gritty Details</br>Minimum weight: 2g </br>Maximum weight: 2000g (2kg)', 64.49, sysdate, '/dist/product/hario-v60-drip-scale-and-timer-HomeBrewing.png');\n" +
				"\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"', 4.99, sysdate, '/dist/product/demitasse_cup-Cups.png');\n" +
				"insert into tbl_prod(p_id, p_category, p_name, p_content, p_price, p_mdate, p_img)\n" +
				...
				"We love this mug and we know you will too. ', 7.49, sysdate, '/dist/product/cowboy_mug-Cups.png');\n");
